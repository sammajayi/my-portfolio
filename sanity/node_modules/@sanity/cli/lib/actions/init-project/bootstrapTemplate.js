...
var _default = async (opts, context) => {
  ...
  const dependencies = Object.assign({}, _versionRanges.default.core, template.dependencies || {});
  ...
  const packageManifest = await (0, _createManifest.createPackageManifest)({
    ...opts,
    dependencies
  });
  ...
  const sanityManifest = template.generateSanityManifest ? template.generateSanityManifest(baseSanityManifest, opts) : baseSanityManifest;
